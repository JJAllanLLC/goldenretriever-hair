        ...
        <div className="mb-8">
          ...
          <form className="max-w-md mx-auto flex flex-col sm:flex-row gap-4">
            <input
              ...
              className="flex-1 px-6 py-4 rounded-full border border-orange-300 text-white placeholder:text-gray-200 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-300"
            />
            <button
              type="submit"
