      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {visibleGuides.map((guide) => (
          <article key={guide.slug} className="bg-white rounded-xl shadow-sm border border-amber-100 overflow-hidden">
            ...
            <div className="p-6">
              {["history-of-the-golden-retriever", "best-dog-food-golden-retrievers-2026", "golden-retriever-grooming-guide", "golden-retriever-shedding-guide", "golden-retriever-basic-obedience-training-guide", "should-you-get-two-golden-retrievers"].includes(
                guide.slug
              ) && (
