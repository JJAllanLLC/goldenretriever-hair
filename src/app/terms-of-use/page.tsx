  ...
  return (
    <main className="bg-amber-50/40 text-gray-900">
      <section className="max-w-2xl mx-auto px-4 py-16 prose prose-lg prose-amber">
        ...
        <p>
          Welcome to GoldenRetriever.hair (<code>https://goldenretriever.hair</code>, the “Site”). These{" "}
        ...
        <ul>
          <li>
            Confirm that you are at least 18 years old or using the Site under the supervision of a parent or legal
            guardian.
          </li>
        ...
        <ul>
          ...
          <li>
            You are responsible for seeking <strong>appropriate professional advice</strong> (such as a licensed
            veterinarian) before making health or safety decisions for your dog.
          </li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>Logos, graphics, and design elements.</li>
          <li>Images, tables, and other media.</li>
        </ul>
        <p>You may:</p>
        <ul>
          <li>View and read content for your personal, non-commercial use.</li>
          <li>Share links to pages on the Site, provided you do not misrepresent our content or imply endorsement.</li>
        </ul>
        <p>You may not, without prior written permission:</p>
        <ul>
          <li>Reproduce, redistribute, republish, or publicly display substantial portions of the Site’s content.</li>
        ...
        <ul>
          ...
          <li>Use the Site to transmit spam, malicious code, or harmful content.</li>
          <li>Harass, threaten, or abuse others through forms or contact methods associated with the Site.</li>
        </ul>
        ...
        <ul>
          <li>We do not control third-party sites or services.</li>
          <li>We are not responsible for the content, privacy practices, or policies of third parties.</li>
          <li>Purchases or interactions with third-party sites are solely between you and the third party.</li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>Errors, omissions, interruptions, or delays in Site operation.</li>
        </ul>
        <p>
