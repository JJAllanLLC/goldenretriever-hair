...
<div className="border border-amber-100 rounded-lg p-3 my-4 bg-white">
  <div className="flex flex-col sm:flex-row gap-3 items-start">
    ...
    <div>
      ...
      <p className="my-1">{'Best for: safe daytime play and controlled space. Durable folding playpen that gives your dog room to move while staying contained. We\'ve used these successfully with our own Golden Retrievers — the 30" height is more than enough to prevent jumping while they learn boundaries. Works great alongside a crate to create a full setup for managing two dogs.'}</p>
      <p className="my-1">
