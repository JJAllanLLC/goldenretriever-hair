...
A properly sized crate makes a huge difference in the first week—it gives your puppy a safe place to sleep and helps speed up potty training:
...
<div className="border border-amber-100 rounded-lg p-4 my-4 bg-white">
  <div className="flex flex-col sm:flex-row gap-4 items-start">
    ...
    />
    <div>
      <p className="my-2"><strong>Best for: a safe, secure sleeping space while you establish routines</strong></p>
      <p className="my-2"><strong>MidWest Homes for Pets iCrate Folding Dog Crate</strong></p>
      <p className="my-2">A folding crate gives puppies a defined den-like space for sleep—making it easier to reinforce calm downtime and crate training starting on day one.</p>
      <p className="my-2">When sized correctly (not oversized), many puppies are less likely to soil where they sleep, which helps reduce overnight accidents during early potty training.</p>
      <p className="my-2">
