...
<div className="border border-amber-100 rounded-lg p-3 my-4 bg-white">
  <div className="flex flex-col sm:flex-row gap-3 items-start">
    ...
    <div>
      ...
      <p className="my-1">
        <a href="https://amzn.to/4rq298l" target="_blank" rel="nofollow sponsored noopener" className="inline-block font-semibold underline text-amber-700 hover:text-amber-800">View on Amazon →</a>
      </p>
    </div>
  </div>
</div>
