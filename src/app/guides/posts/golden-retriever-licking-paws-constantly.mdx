...
seoTitle: "Golden Retriever Licking Paws: Causes & What to Do"
...
featuredImage: "/images/guides/golden-retriever-licking-paws-indoor.jpg"
featuredAlt: "Golden Retriever lying on a rug indoors licking its paw, showing signs of irritation or excessive paw licking"
...
<div className="border border-amber-100 rounded-lg p-3 my-4 bg-white">
  <div className="flex flex-col sm:flex-row gap-3 items-start">
    ...
    <div>
      ...
      <p className="my-1">
        <a href="https://amzn.to/4s91ckF" target="_blank" rel="nofollow sponsored noopener" className="inline-block font-semibold underline text-amber-700 hover:text-amber-800">Check price on Amazon →</a>
      </p>
    </div>
  </div>
</div>
...
<div className="border border-amber-100 rounded-lg p-3 my-4 bg-white">
  <div className="flex flex-col sm:flex-row gap-3 items-start">
    ...
    <div>
      ...
      <p className="my-1">
        <a href="https://amzn.to/4vaOKUm" target="_blank" rel="nofollow sponsored noopener" className="inline-block font-semibold underline text-amber-700 hover:text-amber-800">Check price on Amazon →</a>
      </p>
    </div>
  </div>
</div>
