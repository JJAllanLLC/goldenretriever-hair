...
featuredImage: "/images/guides/golden-retriever-skin-check-magnifying-glass.jpg"
featuredAlt: "Golden Retriever fur being gently examined with a magnifying glass to check skin health and potential hot spots"
---
...
A gentle antimicrobial wound-care spray like the one below can help clean and protect irritated skin while supporting healing.
...
<div className="border border-amber-100 rounded-lg p-3 my-4 bg-white">
  <div className="flex flex-col sm:flex-row gap-3 items-start">
    ...
    <div>
      ...
      <p className="my-1">Gentle antimicrobial spray that helps clean wounds, soothe irritated skin, and support healing for issues like hot spots, cuts, and skin irritation. Safe, non-toxic, and a great addition to your Golden Retriever first-aid kit.</p>
      <p className="my-1">
