...
seoTitle: "Golden Retriever Feeding Amount: Signs & Fixes"
...
featuredImage: "/images/guides/golden-retriever-feeding-amount-two-bowls.jpg"
featuredAlt: "Golden Retriever looking at two bowls of food on a kitchen counter, one overfilled and one underfilled, showing feeding amount decision"
...
<div className="border border-amber-100 rounded-lg p-3 my-4 bg-white">
  <div className="flex flex-col sm:flex-row gap-3 items-start">
    ...
    <div>
      ...
      <p className="my-1">
        <a href="https://amzn.to/4q830cM" target="_blank" rel="nofollow sponsored noopener" className="inline-block font-semibold underline text-amber-700 hover:text-amber-800">Check price on Amazon →</a>
      </p>
    </div>
  </div>
</div>
