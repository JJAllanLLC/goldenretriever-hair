...
<div className="border border-amber-100 rounded-lg p-4 my-4 bg-white">
  <div className="flex flex-col sm:flex-row gap-4 items-start">
    ...
    <div>
      ...
      <p className="my-2">
        <a href="https://amzn.to/4q8rGle" target="_blank" rel="nofollow sponsored noopener" className="inline-block mt-2 font-semibold underline text-amber-700 hover:text-amber-800">Check price on Amazon →</a>
      </p>
    </div>
  </div>
</div>
...
Your vet may prescribe a **medicated shampoo** — antifungal, antibacterial, or anti-itch — with specific instructions on frequency and contact time. Use those exactly as directed. Don't substitute an OTC shampoo for a vet-prescribed one. For more on Golden Retriever skin issues, see our [skin allergies guide](/guides/golden-retriever-skin-allergies) and the broader [Golden Retriever skin-problems guide](/guides/golden-retriever-skin-problems-guide).
